...
#[Fillable(['club_id', 'invoice_creation_id', 'member_id', 'credited_invoice_id', 'document_type', 'status', 'number', 'invoice_date', 'due_date', 'issued_at', 'paid_at', 'paid_amount_ore', 'club_name', 'club_organization_number', 'club_account_number', 'recipient_name', 'recipient_company_name', 'recipient_organization_number', 'recipient_address', 'recipient_postal_code', 'recipient_city', 'recipient_email', 'net_total_ore', 'vat_total_ore', 'gross_total_ore'])]
