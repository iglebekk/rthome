...
return [
    ...
    'create_description' => 'Tildel et medlem, en prioritet og eventuelt en periode.',
    'edit_title' => 'Rediger verv',
    'edit_description' => 'Oppdater ansvar, rekkefølge eller periode.',
    'fields' => [
        'name' => 'Navn på verv',
        'member' => 'Medlem',
        'sort_order' => 'Prioritert rekkefølge',
        'start_date' => 'Startdato',
        'end_date' => 'Sluttdato',
    ],
    'select_member' => 'Velg et medlem',
    'unfilled' => 'Ledig',
    'period' => [
        'open' => 'Åpent',
    ],
